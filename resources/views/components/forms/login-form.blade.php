<form method="post" class="w-full" action="{{ route('login') }}">
    ...
    <div class="mx-auto text-white flex-col flex">
        ...
        <input type="email" name="email" placeholder="Email"
            class="my-2 bg-[#404749] lg:w-[470px] xl:w-[470px] 2xl:w-[470px]  h-[50px] text-[14px] rounded px-4" value="{{ old('email') }}">
        @error('email')
        ...
        <div>
            <span class="text-[14px] mx-2">If you don’t have an account you can
                <a href="{{ route('register.page') }}" class="hover:underline text-[#F87979] mx-2">Sign-up</a>for free</span>
        </div>
    </div>
</form>
